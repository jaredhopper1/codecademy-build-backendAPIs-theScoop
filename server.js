...
function createComment(url, request) {
  ...
  if (requestComment && requestComment.comment && (requestComment.comment.body)
      && database.articles[requestComment.comment.articleId] && database.users[requestComment.comment.username]) {
    const comment = {
